...
var NdvEditDateComponent = (function () {
    function NdvEditDateComponent(el) {
        this.permission = true;
        this.show = false;
        this.save = new core_1.EventEmitter;
        this.el = el;
    }
    NdvEditDateComponent.prototype.ngOnInit = function () {
    ...
    NdvEditDateComponent.prototype.makeEditable = function () {
        if (this.show == false) {
            this.show = true;
        }
    };
    NdvEditDateComponent.prototype.compareEvent = function (globalEvent) {
        if (this.tracker != globalEvent && this.show) {
            this.cancelEditable();
        }
    };
    NdvEditDateComponent.prototype.trackEvent = function (newHostEvent) {
        this.tracker = newHostEvent;
    };
    NdvEditDateComponent.prototype.cancelEditable = function () {
        this.show = false;
        this.ddate = this.originalddate;
    };
    NdvEditDateComponent.prototype.callSave = function () {
        var _this = this;
        var data = {}; //BUILD OBJ FOR EXPORT.
        data["" + this.fieldName] = this.ddate;
        var oldddate = this.ddate;
        setTimeout(function () { _this.originalddate = oldddate; _this.ddate = oldddate; }, 0); //Sets the field with the new ddate;
        this.save.emit(data);
        this.show = false;
    };
    __decorate([
    ...
    ], NdvEditDateComponent.prototype, "holder", void 0);
    __decorate([
        core_1.Input('title'), 
        __metadata('design:type', Object)
    ], NdvEditDateComponent.prototype, "fieldName", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], NdvEditDateComponent.prototype, "permission", void 0);
    NdvEditDateComponent = __decorate([
        core_1.Component({
            selector: 'ndv-date',
    ...
    return NdvEditDateComponent;
})();
exports.NdvEditDateComponent = NdvEditDateComponent;
//# sourceMappingURL=ndv.edit.date.component.js.map